...
//
//	mockgen -source=consumer.go -destination=mock_consumer_test.go -package=consumer -typed
//
...
import (
	consumermodels "ch-3/internal/consumer/consumermodels"
	http "net/http"
	reflect "reflect"
...
func (m *Mockrecorder) Record(event consumermodels.WikiEvent) {
	m.ctrl.T.Helper()
...
func (c *MockrecorderRecordCall) Do(f func(consumermodels.WikiEvent)) *MockrecorderRecordCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockrecorderRecordCall) DoAndReturn(f func(consumermodels.WikiEvent)) *MockrecorderRecordCall {
