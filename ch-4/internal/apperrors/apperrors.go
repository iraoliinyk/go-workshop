...
// StreamError means the reader itself failed, for example the connection was reset
// in the middle of the stream. The caller should pass it up, because the consumer
// cannot continue.
